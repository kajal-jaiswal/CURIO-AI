...
export default async function AuthorDashboard() {
    ...
    return (
        <div>
            <div className="mb-8">
                <h1 className="text-3xl font-bold text-dark-50 mb-2">Welcome Back, {session?.user?.name || 'Author'}! 👋</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <div className="bg-dark-900 border border-dark-800 rounded-lg p-6">
                    ...
                    <div className="text-3xl font-bold text-dark-50 mb-1">{posts.length}</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <Link href="/author/posts/new" className="bg-gradient-to-br from-primary-600 to-primary-700 hover:from-primary-700 hover:to-primary-800 text-white rounded-lg p-6 transition-all">
                ...
                <Link href="/author/posts" className="bg-dark-900 border border-dark-800 hover:border-primary-500 rounded-lg p-6 transition-all">
                ...
                <Link href="/author/analytics" className="bg-dark-900 border border-dark-800 hover:border-primary-500 rounded-lg p-6 transition-all">
            ...
            <div className="bg-dark-900 border border-dark-800 rounded-lg p-6">
                ...
                {posts.length > 0 ? (
                    <div className="space-y-4">
                        {posts.map((post) => (
                            <div key={post.id} className="flex items-center justify-between p-4 bg-dark-800 rounded-lg">
                                ...
                                <Link href={`/author/posts/${post.id}/edit`} className="px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white rounded-lg text-sm transition-colors">
                                    Edit
                                </Link>
                            </div>
                        ))}
                    ...
                    <div className="text-center py-12">
                        ...
                        <Link href="/author/posts/new" className="inline-block px-6 py-3 bg-primary-600 hover:bg-primary-700 text-white rounded-lg transition-colors">
